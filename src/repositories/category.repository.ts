...
> {
  ...
  constructor(
    @inject('datasources.mangito') dataSource: MangitoDataSource, @repository.getter('ProductRepository') protected productRepositoryGetter: Getter<ProductRepository>,
  ) {
